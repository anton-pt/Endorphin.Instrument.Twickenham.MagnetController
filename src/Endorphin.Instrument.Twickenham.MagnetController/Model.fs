...
/// Magnet controller configuration settings.
...
module Model =
    ...
    type MagnetController = internal MagnetController of magnetController : Visa.Instrument * settings : MagnetController.Settings
