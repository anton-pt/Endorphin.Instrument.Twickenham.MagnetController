...
let summary = "F# wrapper for Twickenham Scientific Instruments Superconducting Magnet Controller."

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Library for interacting with a Twickenham Scientific Instruments Superconducting Magnet Controller asynchronously via F#."

// List of author names (for NuGet package)
let authors = [ "University of Warwick EPR and Diamond group" ]

// License header to be added to all source files
...
let gitRaw = environVarOrDefault "gitRaw" "https://raw.github.com/anton-pt"
    ...
    let applyHeader comment formatComment (filename : string) =
        let newContent =
            using (new StreamReader (filename)) (fun file ->
                ...
                if content.StartsWith header then content else header + content)
